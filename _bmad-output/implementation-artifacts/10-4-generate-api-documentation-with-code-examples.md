...
- [x] **Task 5: Create API Surface Reference Guides** (AC: #4, #7)
  - [x] Create `docs/api/llm-providers.md`:
  ...
  - [x] Create `docs/api/agent-renderers.md`:
  ...
  - [x] Create `docs/api/configuration.md`:
    - IAI101Config type overview
    - getConfig, setConfig, updateConfig methods
    - Scope handling (user vs workspace)
    - Listening to configuration changes

- [x] **Task 6: Create Troubleshooting Guide** (AC: #10)
  - [x] Create `docs/api/api-troubleshooting.md`:
...
- [x] **Task 8: Implement Documentation Versioning** (AC: #12)
  - [x] Create `docs/api/versions.json`:
    - List of available versions
    - Current/latest version indicator
    - Used by UI for version selector
  - [x] GitHub Actions workflow includes versioned generation
